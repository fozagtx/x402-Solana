...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 py-12 sm:py-16 container border-t-2 border-gray-200 bg-white/80 backdrop-blur-sm">
            ...
            {socialLinks.map((social) => {
              ...
              return (
                <Link
                  ...
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white border-2 border-gray-200 flex items-center justify-center text-black hover:text-black/80 hover:bg-gray-50 hover:border-gray-300 transition-all duration-300 hover:scale-110 shadow-lg shadow-gray-200/50 hover:shadow-xl hover:shadow-gray-300/60"
